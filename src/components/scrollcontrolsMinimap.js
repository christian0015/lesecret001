    ...
    <Canvas gl={{ antialias: false }} dpr={[1, 1.5]}>
      <Suspense fallback={null}>
        <ScrollControls damping={0.2} pages={3}>
          ...
          <Scroll html>
            <h1 style={{ position: 'absolute', top: '60vh', left: '0.5em', fontSize: '30vw' }}>to</h1>
            <h1 style={{ position: 'absolute', top: '120vh', left: '60vw', fontSize: '30vw' }}>be</h1>
            <h1 style={{ position: 'absolute', top: '198.5vh', left: '0.5vw', fontSize: '40vw' }}>homeZER</h1>
          </Scroll>
        </ScrollControls>
        <Preload />
      </Suspense>
